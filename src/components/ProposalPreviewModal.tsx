  ...
  return (
    <div className="pdf-page bg-white text-slate-900 w-[794px] max-w-[794px] min-h-[1123px] p-9 box-border flex flex-col justify-between shadow-md mb-6 last:mb-0 print:mb-0 print:shadow-none print:break-after-page">
      <div className="flex-1 flex flex-col justify-between">
        ...
        <div className="border-b-2 border-[#00897B] pb-2 mb-5">
          <div className="flex justify-between items-end">
            ...
            <span className="text-[10px] font-bold text-slate-700">Referans Listesi</span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 text-[9.5px]">
          {/* Card 1: Kurumlar */}
          <div className="border border-slate-200 rounded-xl p-4 bg-slate-50/50 shadow-xs flex flex-col justify-between">
            <div>
              <div className="bg-[#00594c] text-white font-bold py-1.5 px-3 rounded-md uppercase text-center text-[9.5px] mb-3">
                KURUMLAR
              </div>
                ...
                <div className="pdf-page bg-white text-slate-900 w-[794px] max-w-[794px] min-h-[1123px] p-9 box-border flex flex-col justify-between shadow-md mb-6 last:mb-0 print:mb-0 print:shadow-none print:break-after-page">
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      {/* Konu Header */}
                      <div className="mb-4 bg-slate-50 p-4 rounded-xl border border-slate-300 text-[10.5px] text-slate-900 space-y-1.5 leading-relaxed">
                        <div className="flex items-baseline">
                          <span className="w-16 font-black text-slate-950 shrink-0">Sayı :</span>
                          <span className="font-mono font-bold text-blue-950">{proposal.proposalNumber}</span>
                        </div>
                        <div className="flex items-baseline">
                          <span className="w-16 font-black text-slate-950 shrink-0">Konu :</span>
                      ...
                      <p className="text-[10px] text-slate-800 leading-relaxed mb-4 text-justify">
                      ...
                      <div className="mb-4">
                        <h2 className="text-[11.5px] font-black text-slate-950 uppercase tracking-wide mb-1.5">
                          1. Fiyat Teklifi ve Kapsam
                        </h2>
                        <p className="text-[10px] text-slate-800 leading-relaxed text-justify mb-2.5">
                          Yapılacak işin birden çok aşamaya sahip olması nedeniyle fiyat teklifimiz iş kalemlerine ayrılmıştır:
                        </p>
                        <div className="bg-slate-100/90 p-3 rounded-xl border border-slate-200 text-[9.5px] text-slate-900 font-semibold space-y-1">
                          <p className="text-slate-800">• <strong>1. Aşama:</strong> Binanın güçlendirme Avan projesine ilişkin zemin ve statik ön analiz işlemleri yer almaktadır.</p>
                          <p className="text-slate-800">• <strong>2. Aşama:</strong> Statik Detay uygulama ve idari onay sürecine ilişkin işlemler yer almaktadır.</p>
                        </div>
                      </div>

                      {/* TABLO 1 */}
                      <div className="mb-4">
                        <div className="bg-slate-900 text-white px-3.5 py-2 rounded-t-xl flex justify-between items-center text-[10px] font-bold">
                        ...
                        <div className="border border-slate-900 text-[9.5px] rounded-b-xl overflow-hidden shadow-xs">
                          <table className="w-full text-left border-collapse">
                            <thead>
                              <tr className="bg-slate-100 border-b border-slate-300 font-bold text-slate-900 text-[9.5px]">
                            ...
                            <tbody className="divide-y divide-slate-200 bg-white">
                              <tr>
                                <td className="py-2.5 px-3 text-center font-bold border-r border-slate-200">1</td>
                              ...
                              <tr className="bg-slate-50/50">
                                <td className="py-2.5 px-3 text-center font-bold border-r border-slate-200">2</td>
                                <td className="py-2.5 px-3 border-r border-slate-200 font-semibold text-slate-900">
                              ...
                              <tr>
                                <td className="py-2.5 px-3 text-center font-bold border-r border-slate-200">3</td>
                                <td className="py-2.5 px-3 border-r border-slate-200 font-semibold text-slate-900">
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 text-[9px] text-slate-700 leading-relaxed mb-1">
                      <p><strong>Önemli Not:</strong> 1. Aşama çalışmaları kapsamında temin edilen zemin etüt verileri ve avan modelleme sonuçları resmî onay süreçlerinde idareye sunulacak teknik altyapıyı oluşturmaktadır.</p>
                    </div>
                  </div>
                ...
                <div className="pdf-page bg-white text-slate-900 w-[794px] max-w-[794px] min-h-[1123px] p-9 box-border flex flex-col justify-between shadow-md mb-6 last:mb-0 print:mb-0 print:shadow-none print:break-after-page">
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      {/* TABLO 2 */}
                      <div className="mb-4">
                        <div className="bg-slate-800 text-white px-3.5 py-2 rounded-t-xl flex justify-between items-center text-[10px] font-bold">
                        ...
                        <div className="border border-slate-800 text-[9.5px] rounded-b-xl overflow-hidden shadow-xs">
                          <table className="w-full text-left border-collapse">
                            <thead>
                            ...
                            <tbody className="divide-y divide-slate-200 bg-white">
                              <tr>
                                ...
                                <td className="py-2 px-3 border-r border-slate-200 font-semibold">Statik Güçlendirme Detay Projelerinin Hazırlanması</td>
                                <td className="py-2 px-3 text-center border-r border-slate-200 font-mono">{proposal.guclendirme?.statikDetayUnitPrice ? `${proposal.guclendirme.statikDetayUnitPrice} TL/m²` : '………… TL/m²'}</td>
                                <td className="py-2 px-3 text-right font-bold font-mono">{(proposal.guclendirme?.statikDetayTotal || 0) > 0 ? `${(proposal.guclendirme?.statikDetayTotal || 0).toLocaleString('tr-TR')} TL` : '………… TL'}</td>
                              </tr>
                              <tr className="bg-slate-50/50">
                                <td className="py-2 px-3 text-center font-bold border-r border-slate-200">2</td>
                                <td className="py-2 px-3 border-r border-slate-200 font-semibold">Elektrik ve Mekanik Projeleri (Tesisat Deplase)</td>
                                <td className="py-2 px-3 text-center border-r border-slate-200 font-mono">{proposal.guclendirme?.elektrikMekanikUnitPrice ? `${proposal.guclendirme.elektrikMekanikUnitPrice} TL/m²` : '………… TL/m²'}</td>
                                <td className="py-2 px-3 text-right font-bold font-mono">{(proposal.guclendirme?.elektrikMekanikTotal || 0) > 0 ? `${(proposal.guclendirme?.elektrikMekanikTotal || 0).toLocaleString('tr-TR')} TL` : '………… TL'}</td>
                              </tr>
                              <tr>
                                <td className="py-2 px-3 text-center font-bold border-r border-slate-200">3</td>
                                <td className="py-2 px-3 border-r border-slate-200 font-semibold">Mimari Tadilat Projeleri</td>
                                <td className="py-2 px-3 text-center border-r border-slate-200 font-mono">{proposal.guclendirme?.mimariTadilatUnitPrice ? `${proposal.guclendirme.mimariTadilatUnitPrice} TL/m²` : '………… TL/m²'}</td>
                                <td className="py-2 px-3 text-right font-bold font-mono">{(proposal.guclendirme?.mimariTadilatTotal || 0) > 0 ? `${(proposal.guclendirme?.mimariTadilatTotal || 0).toLocaleString('tr-TR')} TL` : '………… TL'}</td>
                              </tr>
                              <tr className="bg-slate-50/50">
                                <td className="py-2 px-3 text-center font-bold border-r border-slate-200">4</td>
                                <td className="py-2 px-3 border-r border-slate-200 font-semibold">İTÜ / Yetkili Üniversite Onay Bedeli</td>
                                <td className="py-2 px-3 text-center border-r border-slate-200 font-mono">Sabit / Heyet</td>
                                <td className="py-2 px-3 text-right font-bold font-mono">{(proposal.guclendirme?.ituOnayTotal || 0) > 0 ? `${(proposal.guclendirme?.ituOnayTotal || 0).toLocaleString('tr-TR')} TL` : '………… TL'}</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
                      ...
                      {/* 2. Süreç Tarifi */}
                      <div className="mb-4">
                        <h2 className="text-[11px] font-black text-slate-950 uppercase tracking-wide mb-1.5">
                          2. Süreç Tarifi
                        </h2>
                        <div className="text-[9.5px] text-slate-800 leading-relaxed space-y-1 text-justify bg-slate-50 p-3 rounded-xl border border-slate-200">
                          <p>
                            Teklifimizin kabul edilmesine müteakip taraflar arasında sözleşme imzalanacaktır. Hazırlanacak güçlendirme projeleri <strong>OSB'nin</strong> (veya ilgili Belediyenin / Yetkili İdarenin) onaylayabileceği nitelikte ve 2018 TBDY standartlarına tam uyumlu olacaktır.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="mb-4">
                        <h2 className="text-[11px] font-black text-slate-950 uppercase tracking-wide mb-2">
                          3. Ödeme Koşulları & Hükümler
                        </h2>

                        <div className="grid grid-cols-12 gap-3.5 items-start">
                          <div className="col-span-7 bg-slate-50 border border-slate-300 rounded-xl p-3.5 space-y-1.5 text-[9px] text-slate-900">
                            ...
                            <div className="pt-1.5 border-t border-slate-200 text-[8.5px] text-slate-600 italic">
                              Teklif geçerlilik süresi: <strong>{proposal.paymentTerms.validityDays || 15} takvim günüdür</strong>.
                            </div>
                          </div>

                          <div className="col-span-5 bg-white border border-slate-300 rounded-xl p-3.5 text-[9.5px] space-y-1.5 shadow-xs">
                            <h4 className="font-black text-slate-900 uppercase text-center text-[9.5px] border-b border-slate-200 pb-1.5 mb-1.5">
                              TEKLİF FİYAT ÖZETİ
                            </h4>
                            ...
                            <div className="flex justify-between font-black text-slate-950 border-t border-slate-900 pt-1.5 text-[11px]">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-[9px] mt-2">
                      <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200">
                        <p className="font-bold text-slate-900 uppercase text-[9px]">TEKLİF VEREN KURULUŞ</p>
                        <p className="font-bold text-slate-800 text-[9px] mt-0.5">{companyProfile.name}</p>
                        <p className="text-[8px] text-slate-500">Müh. ve Mim. Hiz. Ltd. Şti.</p>
                        <div className="mt-5 border-b border-slate-300 w-32"></div>
                        <p className="text-[8px] text-slate-400 mt-0.5">Yetkili İmza & Kaşe</p>
                      </div>

                      <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 text-right flex flex-col items-end">
                        <p className="font-bold text-slate-900 uppercase text-[9px]">İŞVEREN / MÜŞTERİ</p>
                        <p className="font-bold text-slate-800 text-[9px] mt-0.5">{proposal.client.name}</p>
                        {proposal.client.contactPerson && (
                          <p className="text-[8px] text-slate-600">Muhatap: {proposal.client.contactPerson}</p>
                        )}
                        <p className="text-[8px] text-slate-500">Teklif Kabul & Onay</p>
                        <div className="mt-5 border-b border-slate-300 w-32"></div>
                ...
                <div className="pdf-page bg-white text-slate-900 w-[794px] max-w-[794px] min-h-[1123px] p-9 box-border flex flex-col justify-between shadow-md mb-6 last:mb-0 print:mb-0 print:shadow-none print:break-after-page">
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      {/* Konu Header */}
                      <div className="mb-4 bg-slate-50 p-4 rounded-xl border border-slate-300 text-[10.5px] text-slate-900 font-medium leading-relaxed">
                      ...
                      <p className="text-[10px] text-slate-800 mb-4 leading-relaxed">
                      ...
                      {/* Table 1 */}
                      <div className="mb-4">
                        <h2 className="font-black text-[11px] text-slate-900 uppercase mb-2">
                          Tablo: 1 Yapılacak İşlemler (2018 TBDY Kapsamında)
                        </h2>

                        <div className="border border-slate-900 text-[9.5px] rounded-xl overflow-hidden shadow-xs">
                          <table className="w-full text-left border-collapse">
                            <thead>
                              <tr className="bg-slate-900 text-white font-bold py-2.5 px-3 text-center text-[10px]">
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 text-[9px] text-slate-700 leading-relaxed">
                ...
                <div className="pdf-page bg-white text-slate-900 w-[794px] max-w-[794px] min-h-[1123px] p-9 box-border flex flex-col justify-between shadow-md mb-6 last:mb-0 print:mb-0 print:shadow-none print:break-after-page">
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="mb-4 pb-1.5 border-b border-slate-900">
                        <h2 className="text-[12px] font-black text-slate-950 uppercase tracking-tight">
                          FİYATLANDIRMA VE TEKLİF DETAYLARI
                        </h2>
                      </div>

                      <div className="space-y-2.5 text-[10px] text-slate-800 mb-4 leading-relaxed bg-slate-50 p-4 rounded-xl border border-slate-200">
                      ...
                      {/* Fiyat Özeti Box */}
                      <div className="bg-white border border-slate-300 rounded-xl p-4 max-w-md mx-auto my-4 text-[10px] space-y-2 shadow-xs">
                        <h4 className="font-black text-slate-900 text-center uppercase tracking-wider border-b border-slate-200 pb-1.5 mb-1.5 text-[10.5px]">
                          TEKLİF FİYAT ÖZETİ
                        </h4>
                        <div className="flex justify-between text-slate-700">
                        ...
                        <div className="flex justify-between font-black text-[12px] text-slate-950 border-t border-slate-300 pt-2">
                          <span>GENEL TOPLAM:</span>
                          <span className="font-mono">
                            {proposal.pricing.totalAmount.toLocaleString('tr-TR')} TL
                          </span>
                      ...
                      {/* Şartlar & İmzalar */}
                      <div className="space-y-1 text-[9px] text-slate-700 mb-4 bg-amber-50/60 p-3 rounded-xl border border-amber-200">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-[9px] mt-2">
                      ...
                      <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 text-right flex flex-col items-end">
                        ...
                        <p className="text-[8px] text-slate-500">Teklif Onay</p>
                        <div className="mt-5 border-b border-slate-300 w-32"></div>
                        <p className="text-[8px] text-slate-400 mt-0.5">İmza & Tarih</p>
                      </div>
                    </div>
                ...
                <div className="pdf-page bg-white text-slate-900 w-[794px] max-w-[794px] min-h-[1123px] p-9 box-border flex flex-col justify-between shadow-md mb-6 last:mb-0 print:mb-0 print:shadow-none print:break-after-page">
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      {/* Konu Header */}
                      <div className="bg-[#f0fdf4] border border-[#86efac] text-slate-950 p-4 rounded-xl mb-4">
                        <h2 className="text-[11px] font-bold text-slate-900 leading-relaxed">
                      ...
                      <div className="mb-3">
                        <div className="border border-[#00594c] rounded-xl overflow-hidden shadow-xs">
                          <table className="w-full text-left text-[9.5px] border-collapse">
                            <thead>
                              <tr className="bg-[#00594c] text-white font-bold text-[10.5px] uppercase">
                                <th className="py-2.5 px-3.5 w-5/12 border-r border-[#004d40]">DENEY ADI</th>
                                <th className="py-2.5 px-3.5 w-7/12">AÇIKLAMA</th>
                              </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-200 bg-white">
                              {proposal.scopeItems
                                ...
                                .map((item, idx) => (
                                  <tr key={item.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-slate-50/50'}>
                                    <td className="py-2 px-3.5 font-bold text-slate-900 w-5/12 align-top border-r border-slate-200">
                                      {item.title}
                                    </td>
                                    <td className="py-2 px-3.5 text-slate-700 leading-snug w-7/12">
                                      {item.description}
                                    </td>
                                  </tr>
                                ))}
                    ...
                    <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3 text-[9px] text-emerald-950 leading-relaxed">
                      <p><strong>Not:</strong> Orta katlı binalarda (4-8 kat ve üzeri) her kattan standartlara uygun numune alımı yapılması yönetmelik gereği zorunludur.</p>
                    </div>
                  </div>
                ...
                <div className="pdf-page bg-white text-slate-900 w-[794px] max-w-[794px] min-h-[1123px] p-9 box-border flex flex-col justify-between shadow-md mb-6 last:mb-0 print:mb-0 print:shadow-none print:break-after-page">
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="mb-4 pb-1.5 border-b border-[#00594c]">
                        <h2 className="text-[11.5px] font-black text-slate-950 uppercase tracking-tight">
                          2019 RYTEİE YÖNETMELİĞİNİN ORTA KATLI BETONARME BİNALARA GÖRE YAPILMASI GEREKEN ÇALIŞMALAR HAKKINDA;
                        </h2>
                      </div>

                      <div className="space-y-2.5 text-[10px] text-slate-800 mb-4 leading-relaxed bg-[#f0fdf4]/50 p-4 rounded-xl border border-[#bbf7d0]">
                      ...
                      {/* Fiyat Detay Tablosu */}
                      <div className="bg-[#f0fdf4]/80 border border-[#86efac] rounded-xl p-4 max-w-md mx-auto my-4 text-[10px] space-y-2 shadow-xs">
                        <h4 className="font-bold text-slate-950 text-center uppercase tracking-wider border-b border-[#a7f3d0] pb-1.5 mb-1.5 text-[10.5px]">
                        ...
                        <div className="flex justify-between font-black text-[12px] text-slate-950 border-t border-[#86efac] pt-2">
                      ...
                      {/* Uyarılar */}
                      <div className="bg-[#fffbeb] border border-[#fde68a] rounded-xl p-3.5 space-y-1.5 text-[9px] text-slate-800 mb-3">
                      ...
                      <div className="space-y-1 text-[9px] text-red-600 font-bold italic mb-4">
                        ...
                        <p className="text-slate-900 not-italic font-bold text-[9px]">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-[9px]">
                      <div className="p-3.5 bg-white rounded-xl border border-slate-200">
                        <p className="font-bold text-slate-900 uppercase text-[9px]">YÜKLENİCİ / FİRMA</p>
                        <p className="font-bold text-slate-800 text-[9px] mt-0.5">{companyProfile.name}</p>
                        <p className="text-[8px] text-slate-500">Müh. ve Mim. Hiz. Ltd. Şti.</p>
                        <div className="mt-5 border-b border-slate-300 w-32"></div>
                        <p className="text-[8px] text-slate-400 mt-0.5">İmza & Kaşe</p>
                      </div>

                      <div className="p-3.5 bg-white rounded-xl border border-slate-200 text-right flex flex-col items-end">
                        <p className="font-bold text-slate-900 uppercase text-[9px]">İŞVEREN / MÜŞTERİ</p>
                        <p className="font-bold text-slate-800 text-[9px] mt-0.5">{proposal.client.name}</p>
                        {proposal.client.contactPerson && (
                          <p className="text-[8px] text-slate-600">Muhatap: {proposal.client.contactPerson}</p>
                        )}
                        <p className="text-[8px] text-slate-500">Adı Soyadı / Ünvanı</p>
                        <div className="mt-5 border-b border-slate-300 w-32"></div>
                        <p className="text-[8px] text-slate-400 mt-0.5">İmza & Tarih</p>
                      </div>
                    </div>
                ...
                <div className="pdf-page bg-white text-slate-900 w-[794px] max-w-[794px] min-h-[1123px] p-9 box-border flex flex-col justify-between shadow-md mb-6 last:mb-0 print:mb-0 print:shadow-none print:break-after-page">
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      {/* Konu Header */}
                      <div className="mb-4 font-bold text-[10.5px] text-slate-900 leading-relaxed bg-blue-50/80 p-4 rounded-xl border border-blue-200">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="border border-blue-950 text-[9.5px] rounded-xl overflow-hidden shadow-xs">
                          <table className="w-full text-left border-collapse">
                            <thead>
                              <tr className="bg-blue-950 text-white font-bold py-2.5 px-3.5 text-center text-[10px]">
                            ...
                            <tbody className="divide-y divide-slate-200 bg-white">
                              {proposal.scopeItems
                                ...
                                .map((item, idx) => (
                                  <tr key={item.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-slate-50/50'}>
                                    <td className="py-2 px-3.5 font-bold text-blue-950 w-5/12 align-top border-r border-slate-200">
                                      {item.title}
                                    </td>
                                    <td className="py-2 px-3.5 text-slate-800 leading-snug w-7/12">
                                      {item.description}
                                    </td>
                                  </tr>
                                ))}
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 text-[9px] text-blue-950 leading-relaxed">
                ...
                <div className="pdf-page bg-white text-slate-900 w-[794px] max-w-[794px] min-h-[1123px] p-9 box-border flex flex-col justify-between shadow-md mb-6 last:mb-0 print:mb-0 print:shadow-none print:break-after-page">
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="mb-4 pb-1.5 border-b border-blue-900">
                        <h2 className="font-black text-[12px] text-blue-950 uppercase tracking-tight">
                          TEKLİF ŞARTLARI, ÖDEME VE İMZA PROTOKOLÜ
                        </h2>
                      </div>

                      <div className="bg-slate-50 p-4 rounded-xl border border-slate-300 text-[9.5px] mb-4 space-y-2">
                        <h3 className="font-extrabold text-blue-950 uppercase text-[9.5px]">
                          2019 RYTEİE YÖNETMELİĞİ & ÖDEME KOŞULLARI
                        </h3>
                        <ul className="space-y-1.5 text-slate-800 list-disc pl-4 text-[9px]">
                      ...
                      {/* Fiyat Özeti Box */}
                      <div className="bg-white border border-slate-300 rounded-xl p-4 max-w-md mx-auto shadow-xs mb-4">
                        <h3 className="font-black text-slate-900 text-center uppercase tracking-wider text-[10.5px] border-b border-slate-200 pb-1.5 mb-2">
                          TEKLİF FİYAT ÖZETİ
                        </h3>
                        ...
                        <div className="space-y-2 text-[10px]">
                          {Number(proposal.property.buildingCount) > 1 ? (
                            <>
                              ...
                              <div className="flex justify-between text-slate-800 font-bold bg-blue-50/70 px-2.5 py-1.5 rounded-lg border border-blue-200">
                          ...
                          {proposal.pricing.kollukKuvvetiIncluded && (
                            <div className="flex justify-between text-amber-950 font-bold bg-amber-50/80 px-2.5 py-1.5 rounded-lg border border-amber-200">
                          ...
                          <div className="flex justify-between text-slate-700 pt-1.5 border-t border-slate-200 text-[9.5px]">
                          ...
                          <div className="flex justify-between text-[12px] font-black text-slate-950 border-t border-slate-900 pt-2">
                            <span>GENEL TOPLAM (KDV Dahil):</span>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-[9px]">
                      ...
                      <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 text-right flex flex-col items-end">
                        <p className="font-bold text-slate-900 uppercase text-[9px]">MÜŞTERİ / YAPI SAHİBİ</p>
                        <p className="font-bold text-slate-800 text-[9px] mt-0.5">{proposal.client.name}</p>
                        {proposal.client.contactPerson && (
                          <p className="text-[8px] text-slate-600">Muhatap: {proposal.client.contactPerson}</p>
                        )}
